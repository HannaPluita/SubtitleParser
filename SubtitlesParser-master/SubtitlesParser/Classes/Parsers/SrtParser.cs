...
namespace SubtitlesParser.Classes.Parsers
{
    ...
    /// </summary>
    public class SrtParser: BaseParser, ISubtitlesParser
    {
...
//------------------------------------------------------------------------------------
            IEnumerable<string> srtSubParts = GetSrtSubtitleParts(reader).ToList();
            ...
            if (srtSubParts.Any())
            {
                ...
                {
                    var lines =
                        srtSubPart.Split(new string[] {Environment.NewLine}, StringSplitOptions.RemoveEmptyEntries)  //StringSplitOptions.None
                            .Select(s => s.Trim())
